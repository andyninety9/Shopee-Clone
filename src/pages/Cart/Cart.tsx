  ...
  return (
    <div className='bg-neutral-100 py-16'>
      {extendedPurchases.length > 0 ? (
                            ...
                            <div className='flex items-center'>
                              ...
                              <div className='flex-grow px-5 pb-2 pt-1'>
                                <Link
                                  ...
                                  className='text-left line-clamp-1 xl:line-clamp-2'
                                >
              ...
              <div className=''>
                ...
                <div className='flex items-center text-sm sm:justify-end'>
                  ...
                  <div className='ml-6 text-orange'>
                    {formatCurrency(totalCheckedSavingPrice - totalCheckedPurchasePrice)}₫
                  </div>
                </div>
              </div>
              <Button
        ...
        <div className='text-center text-[50px] font-light text-orange md:text-[80px]'>Chưa có sản phẩm nào</div>
      )}
    </div>
  )
}
